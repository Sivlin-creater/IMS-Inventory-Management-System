...
export const routes: Routes = [
    ...
    { path: 'category', component: CategoryComponent, canActivate:[Guard], data: {requiresAdmin: true} },
    ...
    { path: 'sell', component: Sale, canActivate:[Guard] },
